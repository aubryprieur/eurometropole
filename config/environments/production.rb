...
Rails.application.configure do
  ...
  config.active_storage.direct_uploads = false  # <-- Ajoute cette ligne
  ...
  config.action_mailer.smtp_settings = {
    ...
    :enable_starttls_auto => (ENV["SMTP_STARTTLS_AUTO"].to_s.downcase == "true"),
  ...
  # config.active_job.queue_name_prefix = "eurometropole_production"
